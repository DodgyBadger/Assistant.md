...
- Use `static/js/vault-explorer-batch-moves.js` for the multi-item Move panel and submission lifecycle; keep atomicity and compensation policy in the server-side vault service.
