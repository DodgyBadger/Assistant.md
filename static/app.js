...
const systemStatus = window.SystemStatus.create({
    state,
    chatElements,
    dashElements,
    configElements,
    ...
    callbacks: {
        ...
        syncRestartFlag: syncRestartFlagWithStorage,
        updateStatus,
...
function fetchExecutionTasks(options) {
    return systemStatus.fetchExecutionTasks(options);
}
